...
df |> mutate(F1erb = 11.17 * log((F1Hz + 312)/(F1Hz + 14680)) + 43,
...
#### ridge plots for RQ2 (old, not vowel-separated)
```{r}
#in hertz
...
#ggsave("rq1ridge.png", plot = last_plot(), device = NULL, scale = 1,dpi = 600)
```
...
p1 <- ggplot(dfe, aes(x = F1Hz, y = AF, fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.2) +
  theme_ridges() +
  scale_fill_manual(values = vowelcolor)+
  ggtitle("vowel E")
...
p2 <- ggplot(dfi, aes(x = F1Hz, y = AF, fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.2) +
  theme_ridges() +
  scale_fill_manual(values = vowelcolor)+
  ggtitle("vowel I")
...
#F2, vowel E
p3 <- ggplot(dfe, aes(x = F2Hz, y = AF, fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.2) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor) +
...
#F2, vowel I
p4 <- ggplot(dfe, aes(x = F2Hz, y = AF, fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.2) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
...
ggsave("rq2ridge.png", plot = last_plot(), device = NULL, scale = 1,dpi = 600)
```
...
```{r}
#AF, F1 vowel E
rq4e <- df |> filter((AF == "AF" & Label == "E" & block == "1") | (AF == "AF" & Label == "E" & block == "2")| (AF == "AF" & Label == "E" & block == "4"))

p4a <- ggplot(rq4e, aes(x = F1Hz, y = block, fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
...
rq4emn <- df |> filter((AF == "MN" & Label == "E" & block == "1") | (AF == "MN" & Label == "E" & block == "2")|(AF == "MN" & Label == "E" & block == "4"))

p4c <- ggplot(rq4emn, aes(x = F1Hz, y = block, fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
