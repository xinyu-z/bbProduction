...
p3 + xlim(0, 1500) + p4 + xlim(0, 1500)

ggsave("rq1ridgeF1MN.png", plot = last_plot(), width = 9.5, height = 3.5, device = NULL, dpi = 600)
...
p2c + xlim(500, 3200) + p2d + xlim(500, 3200)
#ggsave("rq1ridgeF2MN.png", plot = last_plot(), width = 9.5, height = 3.5, device = NULL, dpi = 600)
```
...
ggsave("rq2ridgeF1.png", plot = last_plot(), width = 9, height = 5, device = NULL, scale = 1,dpi = 600)
