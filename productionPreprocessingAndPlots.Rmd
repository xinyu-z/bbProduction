...
p2 <- ggplot(rq1i, aes(x = F1Hz, y = block, fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
...
p3 <- ggplot(rq1emn, aes(x = F1Hz, y = block, fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
...
p4 <- ggplot(rq1imn, aes(x = F1Hz, y = block, fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
...
p2a <- ggplot(rq2e, aes(x = F2Hz, y = block, fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
...
p2b <- ggplot(rq2i, aes(x = F2Hz, y = block, fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
...
p2c <- ggplot(rq2emn, aes(x = F2Hz, y = block, fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
...
p2d <- ggplot(rq2imn, aes(x = F2Hz, y = block, fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
...
f1af <- ggplot(superAF, aes(x = F1Hz, y = block, fill = BB, linetype = Label)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
  ggtitle("regular auditory feedback at block 2")
...
f1mn<- ggplot(superMN, aes(x = F1Hz, y = block, fill = BB, linetype = Label)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
  ggtitle("Masking noise at block2")

f2af <- ggplot(superAF, aes(x = F2Hz, y = block, fill = BB, linetype = Label)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
...
f2mn<- ggplot(superMN, aes(x = F2Hz, y = block, fill = BB, linetype = Label)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
...
#ggsave("overviewridge.png", plot = last_plot(), width = 10, height = 5, device = NULL, scale = 1,dpi = 600)
