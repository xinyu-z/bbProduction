...
#adding a column for ERB

df<- df |> mutate(F1erb = 11.17 * log((F1Hz + 312)/(F1Hz + 14680)) + 43,
             F2erb = 11.17 * log((F2Hz + 312)/(F1Hz + 14680)) + 43)
...
bbprentestE<- df |> dplyr::filter(BB == "BB", Label == "E") |> filter(block == "1" | block == "2") |> mutate(block = case_when(block == "1" ~ "pretest",
                        block == "2" ~ "test"))
...
#### ridge plots for RQ1 (old, not vowel-separated)
```{r}
#in hertz
library(dplyr)
#AF, F1
...
ggplot(afdf, aes(x = F1Hz, y = as.factor(block), fill = BB, linetype = Label)) +
...
#AF, F2
ggplot(afdf, aes(x = F2Hz, y = as.factor(block), fill = BB, linetype = Label)) +
  geom_density_ridges(alpha = 0.6, scale = 1.2) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)
...
ggplot(mndf, aes(x = F1Hz, y = as.factor(block), fill = BB, linetype = Label)) +
  geom_density_ridges(alpha = 0.6, scale = 1.2) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)
...
#MN F2
ggplot(mndf, aes(x = F2Hz, y = as.factor(block), fill = BB, linetype = Label)) +
  geom_density_ridges(alpha = 0.6, scale = 1.2) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)
...
##### let's also separate the aditory feedback conditions. Because they look different.

```{r}
#AF, F1 vowel E
rq1e <- df |> filter((AF == "AF" & Label == "E" & block == "1") | (AF == "AF" & Label == "E" & block == "2"))

p1 <- ggplot(rq1e, aes(x = F1Hz, y = as.factor(block), fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
  ylab("testing block")+
  ggtitle("vowel E, regular auditory feedback")

#AF, F1 vowel I 
rq1i <- df |> filter((AF == "AF" & Label == "I" & block == "1") | (AF == "AF" & Label == "I" & block == "2"))

p2 <- ggplot(rq1i, aes(x = F1Hz, y = as.factor(block), fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
  ylab("testing block")+
  ggtitle("vowel I, regular auditory feedback")

#unifying the x-axis
p1 + xlim(0, 1500) + p2 + xlim(0, 1500)

#ggsave("rq1ridgeF1.png", plot = last_plot(), width = 9.5, height = 3.5, device = NULL, dpi = 600)

rq1emn <- df |> filter((AF == "MN" & Label == "E" & block == "1") | (AF == "MN" & Label == "E" & block == "2"))

p3 <- ggplot(rq1emn, aes(x = F1Hz, y = as.factor(block), fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
  ylab("testing block")+
  ggtitle("vowel E, masking noise")

rq1imn <- df |> filter((AF == "MN" & Label == "I" & block == "1") | (AF == "MN" & Label == "I" & block == "2"))

p4 <- ggplot(rq1imn, aes(x = F1Hz, y = as.factor(block), fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
  ylab("testing block")+
  ggtitle("vowel I, masking noise")

p1 + xlim(0, 1500) + p2 + xlim(0, 1500) + p3 + xlim(0, 1500) + p4 + xlim(0, 1500)

ggsave("rq1ridgeF1AFMN.png", plot = last_plot(), width = 9.5, height = 5.5, device = NULL, dpi = 600)
...
#AF, F2 vowel E
rq2e <- df |> filter((AF == "AF" & Label == "E" & block == "1") | (AF == "AF" & Label == "E" & block == "2"))

p2a <- ggplot(rq2e, aes(x = F2Hz, y = as.factor(block), fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
...
#AF, F2 vowel I 
rq2i <- df |> filter((AF == "AF" & Label == "I" & block == "1") | (AF == "AF" & Label == "I" & block == "2"))

p2b <- ggplot(rq2i, aes(x = F2Hz, y = as.factor(block), fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
...
p2a + xlim(500, 3200) + p2b + xlim(500, 3200)
ggsave("rq1ridgeF2.png", plot = last_plot(), width = 9.5, height = 3.5, device = NULL, dpi = 600)

rq2emn <- df |> filter((AF == "MN" & Label == "E" & block == "1") | (AF == "MN" & Label == "E" & block == "2"))

p2c <- ggplot(rq2emn, aes(x = F2Hz, y = as.factor(block), fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
...
rq2imn <- df |> filter((AF == "MN" & Label == "I" & block == "1") | (AF == "MN" & Label == "I" & block == "2"))

p2d <- ggplot(rq2imn, aes(x = F2Hz, y = as.factor(block), fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
...
p2a + xlim(500, 3200) + p2b + xlim(500, 3200) + p2c + xlim(500, 3200) + p2d + xlim(500, 3200)
#ggsave("rq1ridgeF2AFMN.png", plot = last_plot(), width = 9.5, height = 5.5, device = NULL, dpi = 600)
```
...
#### ridge plots for RQ2 (separating vowels)
```{r}

#F1, vowel E
dfe <- df |> filter(Label == "E")
rq2Ef1 <- ggplot(dfe, aes(x = F1Hz, y = AF, fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.2) +
  theme_ridges() +
  scale_fill_manual(values = vowelcolor)+
  ggtitle("vowel E")
...
#F1, vowel I
dfi <- df |> filter(Label == "I")
rq2If1 <- ggplot(dfi, aes(x = F1Hz, y = AF, fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.2) +
  theme_ridges() +
  scale_fill_manual(values = vowelcolor)+
  ggtitle("vowel I")
...
#F2, vowel E
rq2Ef2 <- ggplot(dfe, aes(x = F2Hz, y = AF, fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.2) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor) +
...
#F2, vowel I
rq2If2 <- ggplot(dfi, aes(x = F2Hz, y = AF, fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.2) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
...
rq2Ef1 + xlim(0, 1700) + rq2If1 + xlim(0, 1700) + rq2Ef2 + xlim(0, 3500) + rq2If2 + xlim(0, 3500)
  
ggsave("rq2ridge.png", plot = last_plot(), width = 9, height = 5, device = NULL, scale = 1,dpi = 600)

rq2Ef1 + xlim(0, 3500) + rq2If1 + xlim(0, 3500) + rq2Ef2 + xlim(0, 3500) + rq2If2 + xlim(0, 3500)

#ggsave("rq2ridgeF1same.png", plot = last_plot(), width = 9, height = 5, device = NULL, scale = 1,dpi = 600)
```


### ridge plots for RQ3 (original, but now an overview plot)

```{r}
#AF, F1 vowel E
superAF <- df |> filter((AF == "AF" & block == "1") | (AF == "AF" & block == "2")| (AF == "AF" & block == "4"))

f1af <- ggplot(superAF, aes(x = F1Hz, y = as.factor(block), fill = BB, linetype = Label)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
  ylab("testing block")+
  ggtitle("regular auditory feedback")

#AF, F1 vowel I 
#rq4i <- df |> filter((AF == "AF" & Label == "I" & block == "1") | (AF == "AF" & Label == "I" & block == "2") | (AF == "AF" & Label == "I" & block == "4"))

#p4b <- ggplot(rq4i, aes(x = F1Hz, y = block, fill = BB)) +
  #geom_density_ridges(alpha = 0.6, scale = 1.0) +
  #theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  #scale_fill_manual(values = vowelcolor)+
...
superMN <- df |> filter((AF == "MN" & block == "1") | (AF == "MN" & block == "2")|(AF == "MN" & block == "4"))

f1mn<- ggplot(superMN, aes(x = F1Hz, y = as.factor(block), fill = BB, linetype = Label)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
  ylab("testing block")+
  ggtitle("masking noise")

f2af <- ggplot(superAF, aes(x = F2Hz, y = as.factor(block), fill = BB, linetype = Label)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
...
f2mn<- ggplot(superMN, aes(x = F2Hz, y = as.factor(block), fill = BB, linetype = Label)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
...
f1af +xlim(200,1250) + f1mn + xlim(200,1250) + f2af + xlim(500, 3200)+ f2mn+ xlim(500, 3200)

ggsave("overviewridge.png", plot = last_plot(), width = 9, height = 5, device = NULL, scale = 1,dpi = 600)



#rq4imn <- df |> filter((AF == "MN" & Label == "I" & block == "1") | (AF == "MN" & Label == "I" & block == "2") | (AF == "MN" & Label == "I" & block == "4"))

#p4d <- ggplot(rq4imn, aes(x = F1Hz, y = block, fill = BB)) +
  #geom_density_ridges(alpha = 0.6, scale = 1.0) +
  #theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  #scale_fill_manual(values = vowelcolor)+
...
#p4a + xlim(0,1700) + p4b + xlim(0,1700) + p4c + xlim(0,1700) + p4d + xlim(0,1700)
#ggsave("rq3ridge.png", plot = last_plot(), device = NULL, scale = 1,dpi = 600)
```
...
p3a <- ggplot(rq4e, aes(x = F2Hz, y = block, fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
...
#AF, F2 vowel I 
p3b <- ggplot(rq4i, aes(x = F2Hz, y = block, fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
...
p3c <- ggplot(rq4emn, aes(x = F2Hz, y = block, fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
...
p3d <- ggplot(rq4imn, aes(x = F2Hz, y = block, fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
...
### RQ3 but only showing blocks 1 and 4 and pooling across AF conditions

```{r}
#F1 vowel E
rq3e <- df |> filter((Label == "E" & block == "1") | (Label == "E" & block == "4"))

rq3ef1 <- ggplot(rq3e, aes(x = F1Hz, y = block, fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
...
#F1 vowel I 
rq3i <- df |> filter((Label == "I" & block == "1") | (Label == "I" & block == "4"))

rq3if1 <- ggplot(rq3i, aes(x = F1Hz, y = block, fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
...
#F2 vowel E
rq3ef2 <- ggplot(rq3e, aes(x = F2Hz, y = block, fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
...
#F2 vowel I 
rq3if2 <- ggplot(rq3i, aes(x = F2Hz, y = block, fill = BB)) +
  geom_density_ridges(alpha = 0.6, scale = 1.0) +
  theme_ridges() +
  #scale_fill_discrete(breaks = c ("F1Hertz","F2Hertz")) +
  scale_fill_manual(values = vowelcolor)+
...
rq3ef1 + rq3if1 + rq3ef2 + xlim(0,3500) + rq3if2+ xlim(0,3500)

ggsave("rq3ridge.png", plot = last_plot(), device = NULL, width = 9, height = 5,dpi = 600)
```
