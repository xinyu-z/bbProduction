...
ggplot(data = nbi, aes(x = F2Hz, y = F1Hz, color = block))+
  geom_point(alpha = 0.5) +xlim(1250, 2750) + ylim(100, 1750)
...
ggplot(data = nbe, aes(x = F2Hz, y = F1Hz, color = block))+
  geom_point(alpha = 0.8) +ylim(100, 1750)+xlim(1250,2750)
...
ggplot(data = nb, aes(x = F2Hz, y = F1Hz, color = block, shape = Label))+
  geom_point(alpha = 0.7) +ylim(100, 1750)+ xlim(1250,2750)

pi<- ggplot(data = nbi, aes(x = F2Hz, y = F1Hz, color = block))+
  geom_point(alpha = 0.5) +xlim(1250, 2750) + ylim(100, 1750) + labs(title = "pre vs post I")

pe<-ggplot(data = nbe, aes(x = F2Hz, y = F1Hz, color = block))+
  geom_point(alpha = 0.8) +ylim(100, 1750)+xlim(1250,2750)+ labs(title = "pre vs post E")
pi + pe
```
...
p1 <- ggplot(data = bbpre, aes(x = F2Hz, y = F1Hz, color = Label))+
  geom_point(alpha = 0.5) + xlim(1200,3000) + ylim(100, 1500)
...
#ggsave("ridgeBlock2AF.png", plot = last_plot(), device = NULL, scale = 1,dpi = 600)
```
